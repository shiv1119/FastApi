...
BOOKS = [
    Book(1, 'Computer Science Bro', 'codingwithroby', 'A very nice book!', 5, 2030),
    Book(2, 'Be fast with fast api', 'codingwithroby', 'A great book!', 5, 2030),
    Book(3, 'Master endpoints', 'codingwithroby', 'A awesome book!', 5, 2029),
    Book(4, 'Hp1', 'Author 1', 'Book Description', 2, 2028),
    Book(5, 'Hp2', 'Author 2', 'Book Description', 3, 2027),
    Book(6, 'Hp2', 'Author 3', 'Book Description', 1, 2026),
